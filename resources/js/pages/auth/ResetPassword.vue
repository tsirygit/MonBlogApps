...
<script setup>
/**
 * Composant : ResetPassword.vue
 *
 * Permet à l'utilisateur de réinitialiser son mot de passe via un lien reçu par email.
 * Utilise Inertia.js pour envoyer une requête POST à la route 'password.store'.
 */

import Input from '@/composables/UI/Input.vue'; // Champ de formulaire réutilisable
import { Head, useForm } from '@inertiajs/vue3'; // Outils Inertia pour navigation et formulaire
import { ref } from 'vue';
 ...
 *
 * @prop {String} email - Adresse email préremplie
 * @prop {String} token - Jeton de réinitialisation transmis dans l'URL
 */
 ...
 * Envoie une requête POST à la route 'password.store'
 * Réinitialise les champs sensibles après soumission
 */
const submit = () => {
